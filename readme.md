...
- **Text review** – Kimi (`KIMI_API_KEY`, optional `MOONSHOT_QA_MODEL`), OpenAI (`OPENAI_API_KEY`, optional `OPENAI_API_BASE`, `OPENAI_QA_MODEL`, `OPENAI_TIMEOUT_MS`), and Qwen (`DASHSCOPE_API_KEY`, optional `QWEN_QA_MODEL`).
